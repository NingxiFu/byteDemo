...
func (p *Req) FastReadField2(buf []byte) (int, error) {
	offset := 0
...
func (p *Req) fastWriteField2(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *UserServiceCreatUserArgs) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_UserServiceCreatUserArgs[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *UserServiceCreatUserArgs) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *UserServiceCreatUserArgs) FastWrite(buf []byte) int {
	return 0
}

func (p *UserServiceCreatUserArgs) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "CreatUser_args")
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], binaryWriter)
	}
	offset += bthrift.Binary.WriteFieldStop(buf[offset:])
...
func (p *UserServiceCreatUserArgs) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("CreatUser_args")
	if p != nil {
		l += p.field1Length()
	}
	l += bthrift.Binary.FieldStopLength()
...
func (p *UserServiceCreatUserArgs) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *UserServiceCreatUserArgs) field1Length() int {
	l := 0
...
func (p *UserServiceCreatUserResult) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_UserServiceCreatUserResult[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *UserServiceCreatUserResult) FastReadField0(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *UserServiceCreatUserResult) FastWrite(buf []byte) int {
	return 0
}

func (p *UserServiceCreatUserResult) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "CreatUser_result")
	if p != nil {
...
func (p *UserServiceCreatUserResult) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("CreatUser_result")
	if p != nil {
		l += p.field0Length()
	}
	l += bthrift.Binary.FieldStopLength()
...
func (p *UserServiceCreatUserResult) fastWriteField0(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetSuccess() {
...
func (p *UserServiceCreatUserResult) field0Length() int {
	l := 0
	if p.IsSetSuccess() {
...
func (p *UserServiceCreatUserArgs) GetFirstArgument() interface{} {
	return p.Req
}

func (p *UserServiceCreatUserResult) GetResult() interface{} {
	return p.Success
}
